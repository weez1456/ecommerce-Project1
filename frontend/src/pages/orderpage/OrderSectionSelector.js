      ...
      <div className="d-flex align-items-center justify-content-around py-3">
              <div style={{cursor:"pointer"}} onClick={()=>setFilter('awaitingPayment')} className="d-flex flex-column gap-3 align-items-center">
                ...
                <span style={{position:"relative"}} className={filter === "awaitingPayment" ? "d-none d-md-flex headerBottomLocation1" : "d-none d-md-flex"}>Unpaid 
                   <div style={{position:"absolute", top:-15, right:-22}}> <Badge style={{borderRadius:"20px"}} bg="danger">{filterOrders('awaitingPayment', singleArray).length}</Badge></div>
               </span>
                <span style={{ fontSize: '13px', position:"relative" }} className={filter === "awaitingPayment" ? "headerBottomLocation1 d-md-none" : " d-md-none"}>
                  Unpaid <div style={{position:"absolute", top:-15, right:-10}}> <Badge style={{borderRadius:"20px"}} bg="danger">{filterOrders('awaitingPayment', singleArray).length}</Badge></div>
                </span>
              </div>
              <div style={{cursor:"pointer"}} onClick={()=>setFilter('paid')} className={filter === 'paid' ? "d-flex flex-column gap-3 align-items-center " :"d-flex flex-column gap-3 align-items-center"}>
                ...
                <span style={{position:"relative"}} className={ filter === 'paid' ? "d-none d-md-flex headerBottomLocation1": "d-none d-md-flex"}>To be shipped <div style={{position:"absolute", top:-15, right:-18}}> <Badge style={{borderRadius:"20px"}} bg="danger">{filterOrders('paid', singleArray).length}</Badge></div></span>
                <span style={{ fontSize: '13px', position:"relative"}} className={filter === "paid" ? " d-md-none headerBottomLocation1" : " d-md-none"}>
                  To be shipped  <div style={{position:"absolute", top:-15, right:-10}}> <Badge style={{borderRadius:"20px"}} bg="danger">{filterOrders('paid', singleArray).length}</Badge></div>
                </span>
              </div>
              <div style={{cursor:"pointer"}} onClick={()=>setFilter('shiped')} className="d-flex flex-column gap-3 align-items-center">
                ...
                <span style={{position:"relative"}} className={ filter === 'shiped' ? "d-none d-md-flex headerBottomLocation1": "d-none d-md-flex"}>Shipped <div style={{position:"absolute", top:-15, right:-20, }}> <Badge  style={{borderRadius:"20px"}} bg="danger">{filterOrders('shiped', singleArray).length}</Badge></div></span>
                <span style={{ fontSize: '13px', position:"relative" }} className={ filter === 'shiped' ? " d-md-none headerBottomLocation1": " d-md-none"}>
                  Shipped <div style={{position:"absolute", top:-15, right:-10}}> <Badge style={{borderRadius:"20px"}} bg="danger">{filterOrders('shiped', singleArray).length}</Badge></div>
                </span>
              </div>
              <div style={{cursor:"pointer"}} onClick={()=>setFilter('delivered')} className="d-flex flex-column gap-3 align-items-center">
                ...
                <span style={{position:"relative"}} className={ filter === 'delivered' ? "d-none d-md-flex headerBottomLocation1": "d-none d-md-flex"}>To be reviewed <div style={{position:"absolute", top:-15, right:-22}}> <Badge style={{borderRadius:"20px"}} bg="danger">{filterOrders('delivered', singleArray).length}</Badge></div></span>
                <span style={{ fontSize: '13px', position:"relative" }} className={ filter === 'delivered' ? " d-md-none headerBottomLocation1": " d-md-none"}>
                  To be reviewed <div style={{position:"absolute", top:-15, right:-10}}> <Badge style={{borderRadius:"20px"}} bg="danger">{filterOrders('delivered', singleArray).length}</Badge></div>
                </span>
              </div>
            </div>
      <div >
